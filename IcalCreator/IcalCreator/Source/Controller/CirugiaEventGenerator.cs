...
namespace IcalCreator.Controller
{
    ...
    /// las cirugías, los datos de los asistentes y los datos del evento,
    /// así cómo los métodos de envío
    /// </summary>
    public class CirugiaEventGenerator
    {
        ...
        public void SendEventCommandLine(int episodio)
        {
            ...
            { 
                EmailSettings emailSettings = new EmailSettings()
                {
                    ...
                    PuertoSmtp = int.Parse(EmailValues.SmtpPort),
                    ActivarSsl = EmailValues.SslActive == "1" ? true : false,
                    AsuntoMensaje = "Recordatorio de cirugía programada",
                    CuerpoMensaje = "Recordatorio de cirguía programada"
                };
